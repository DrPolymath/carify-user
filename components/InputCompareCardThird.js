...
const InputCompareCardThird = (props) => {
...
const mapStateToProps = (state) => {
    return {
        carBrands: state.firestore.ordered.carBrandThird,
        carModels: state.firestore.data.carModelThird,
        carVariants: state.firestore.data.carVariantThird,
    }
}
...
export default compose(
    ...
    firestoreConnect([
        { 
            collection: 'carBrand',
            storeAs: 'carBrandThird'
        },
        {
            collectionGroup: 'carModel',
            storeAs: 'carModelThird'
        },
        {
            collectionGroup: 'carVariant',
            storeAs: 'carVariantThird'
        }
    ])
