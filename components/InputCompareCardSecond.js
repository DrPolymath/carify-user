...
const InputCompareCardSecond = (props) => {
...
const mapStateToProps = (state) => {
    return {
        carBrands: state.firestore.ordered.carBrandSecond,
        carModels: state.firestore.data.carModelSecond,
        carVariants: state.firestore.data.carVariantSecond,
    }
}
...
export default compose(
    ...
    firestoreConnect([
        { 
            collection: 'carBrand',
            storeAs: 'carBrandSecond'
        },
        {
            collectionGroup: 'carModel',
            storeAs: 'carModelSecond'
        },
        {
            collectionGroup: 'carVariant',
            storeAs: 'carVariantSecond'
        }
    ])
